...
export const defaultMovementGroups = [
  ...
  "Vertical pull (Lat bias)",
  "Vertical pull (Upper back bias)",
  "Horizontal pull (Lat bias)",
  "Horizontal pull (Upper back bias)",
  "Shoulder extension",
  "Lat pull-around",
  "Shrug/elevation",
  "Vertical press",
...
export const defaultExercises: SeedExercise[] = [
  ...
  },
  {
    ...
    movementGroup: "Vertical pull (Lat bias)",
    primary: ["Lats"],
  ...
  },
  {
    ...
    movementGroup: "Horizontal pull (Upper back bias)",
    primary: ["Upper back"],
