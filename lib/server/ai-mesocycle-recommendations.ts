...
- Upper, Mid and Lower chest are independently selectable emphases, but pressing work overlaps anatomically and in local recovery cost. Chest (unclassified) represents older general-chest records or exercises that require manual classification, not a fourth chest region. Historical total-chest targets cannot establish an individualized dose-response for one region; treat retrospectively classified exercise exposures as tentative evidence.
