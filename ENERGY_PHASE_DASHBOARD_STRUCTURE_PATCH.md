...
- Home shows the declared phase and transition caveat. The priority volume section reports completed effective work without presenting old numeric targets as pass/fail quotas. It uses active T3 high-priority/growth assignments for the emphasized muscles, hides the generic “all fine” signal and old target-ratio alarms, removes a duplicated Progress link, and gives body metrics more room on mobile. The full analytics remain available on Progress.
